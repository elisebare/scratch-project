...
class Dropdown extends Component {
  ...
  ToggleButton(event) {
    ...
    const priority = this.props.text.split(" ")[0].toLowerCase()
  ...
  render() {
    ...
    const articles = links.map(link => {
      return <Article toggleButton={this.ToggleButton} id={link.link_id} handleFlag={this.props.handleFlag} url={link.url} title={link.title} />
    });
    return (
